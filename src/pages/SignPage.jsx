...
const LoginPage = () => {
  ...
  return (
    ...
    <div className="absolute z-10 w-full flex min-h-screen justify-center ">
      ...
      <p className="text-[18px] mt-[44px] mb-[56px] justify-center grid place-items-center w-[375px] h-[64px] text-center font-semibold">Sign Up</p>
        ...
        <form className='mx-[16px] items-center'>
            ...
            <div className="flex mb-[24px] w-[343px] h-[56px] items-center border rounded-[16px] py-[8px] px-[16px] gap-[10px]">
              <input
                ...
                className="outline-none w-full bg-transparent text-gray-800 placeholder-gray-500"
              />
              <span className="mr-2 text-2xl "><IoEyeOutline /></span>
          </div>
          
          <div class="flex items-center mb-[24px]">
            <input type="checkbox" className="w-[32px] h-[32px] mr-[10px] accent-[#42AB39]" />
          ...
          <button
            type="submit"
            className="text-[18px] leading-[100%] bg-[#42AB39] hover:bg-white hover:text-black text-white mb-[24px] w-[343px] h-[56px] py-[8px] px-[16px] gap-[10px] rounded-[16px] font-semibold" onClick={handleView}
          > 
            Sign Up
          </button>
          <div className="text-center text-[#91919F] cursor-pointer font-medium" >
            Already have an account? <a className='text-[#42AB39] underline' onClick={handleSign}>Login</a>
          </div>
        </form>
      </div>
    </div>
