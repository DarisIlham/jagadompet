...
<div className="w-[375px] h-[64px]  mt-[44px] flex justify-center items-center ">
  <div className='w-[337px] h-[40px] flex items-center justify-between'>
    <div className="w-[38px] h-[38px] bg-gray-300 rounded-full"><img src={pp}/></div>
...
<div className="flex flex-col">
  {/* Income */}
  <div className="w-[335px] h-[80px] bg-[#00C153] rounded-[28px] flex items-center mx-[20px]">
    <div className='flex mx-[17px]'>
      <div className="w-[48px] h-[48px] bg-white rounded-[16px] grid justify-center items-center"><img src={inc} /></div>
    </div>
    <div className="flex flex-col ml-[10px]">
        <p className="text-[#FCFCFC] text-[14px] font-medium">Income</p>
        <p className="text-[#FCFCFC] text-[22px] font-semibold">Rp 1.500.000</p>
      </div>
  </div>

  <div className="w-[335px] h-[80px] bg-[#FA2F34] mt-[12px] rounded-[28px] flex items-center mx-[20px]">
    <div className='flex mx-[17px]'>
      <div className="w-[48px] h-[48px] bg-white rounded-[16px] grid justify-center items-center"><img src={exp} /></div>
    </div>
    <div className="flex flex-col ml-[10px]">
        <p className="text-[#FCFCFC] text-[14px] font-medium">Expenses</p>
        <p className="text-[#FCFCFC] text-[22px] font-semibold">Rp 500.000</p>
      </div>
  </div>
...
<div className='w-[375px] h-[48px] items-center flex mt-[24px]'>
  <p className="pl-[20px] gap-[10px] font-semibold text-[18px] leading-[100%]">Spend Frequency</p>
</div>
...
<div className='w-[375px] h-[48px] items-center flex mt-[24px] mb-3'>
  <p className="pl-[20px] gap-[10px] font-semibold text-[18px] leading-[100%]">Recent Transaction</p>
  <button className="ml-[95px] bg-[#CCFFC8] text-[#42AB39] text-sm font-semibold w-[78px] h-[32px] rounded-[40px] flex items-center justify-center">
    See All
  </button>
</div>
...
<div className="flex flex-col gap-[6px]">
  ...
  <div className="flex items-center justify-between bg-[#FCFCFC] p-4 rounded-[24px]  w-[335px] h-[89px] mx-[20px]">
    ...
    <div className="text-right">
      <p className="text-[#FD3C4A] text-[16px] font-semibold mb-[12px] ">- $120</p>
  ...
  <div className="flex items-center justify-between bg-[#FCFCFC] p-4 rounded-[24px]  w-[335px] h-[89px] mx-[20px]">
    <div className="flex items-center gap-3">
      ...
      <div>
        <p className="font-medium text-[16px] mb-[12px]">Subscription</p>
        <p className="text-[#91919F] text-[13px]">Disney+ Annual...</p>
      </div>
    </div>
    <div className="text-right">
      <p className="text-[#FD3C4A] text-[16px] font-semibold mb-[12px]">- $80</p>
  ...
  <div className="flex items-center justify-between bg-[#FCFCFC] p-4 rounded-[24px] w-[335px] h-[89px] mx-[20px]">
    ...
    <div className="text-right">
      <p className="text-[#FD3C4A] text-[16px] font-semibold mb-[12px]">- $32</p>
