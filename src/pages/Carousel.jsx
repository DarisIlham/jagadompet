  ...
  return (
      <div className="relative w-full max-w-[375px] mx-auto">
          ...
          <div className='w-full flex  justify-center mt-[38px]'>
            ...
            <button
              type="submit"
              className="text-[18px] leading-[100%] bg-[#42AB39] hover:bg-white hover:text-black text-white w-[343px] h-[56px] py-[8px] px-[16px] gap-[10px] rounded-[16px] font-semibold" onClick={handleSign}
            > 
              Sign Up
            </button>
          </div>
          <div className='w-full flex justify-center mt-[16px]'>
            <button
              type="submit"
              className="text-[18px]  bg-[#CCFFC8] hover:bg-white hover:text-black text-[#02791D] mb-[24px] w-[343px] h-[56px] py-[8px] px-[16px] gap-[10px] rounded-[16px] font-semibold" onClick={handleLogin}
            > 
              Login
            </button>
          </div>
