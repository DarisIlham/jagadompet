      ...
      {/* Back button */}
        ...
        <div className='absolute z-10 flex bg-white w-[375px] h-[564px] mt-[23px] rounded-t-[32px] flex-col'>
            ...
            <div className='flex w-full h-[74px]  mt-[263px] items-center'>
                <div className='flex w-[160px] h-[56px]  ml-[16px] rounded-[16px] bg-[#FCAC12] items-center justify-center text-[18px] text-[#FCFCFC] font-semibold'>Edit</div>
                <div className='flex w-[160px] h-[56px] border-[#FA2F34] border-2 ml-[23px] rounded-[16px] items-center justify-center text-[18px] text-[#FA2F34] font-semibold' onClick={handleDeleteClick}> Delete </div>
            </div>
        </div>
          ...
          <div className="bg-white rounded-[21.7px] w-[340px] h-[174.21px] text-center">
            <div className='m-[13px]'>
                <div className='flex flex-col h-[80px]'>
                    <div className="text-[21.7px] font-semibold mb-2 mt-[13px]">Delete This Transaction?</div>
